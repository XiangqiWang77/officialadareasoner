...
def evaluate_few_shot_with_multiple_responses(ts_model, task, shots, eval_model): # Added eval_model as input
    ...
    output_file = os.path.join(output_dir, f"{eval_model}1.json") # Dynamic output file path

    with open(output_file, "w") as f:
        f.write("[\n")


        ts_model.load_parameters('mmlu.pkl')
        #ts_model.plot_reward_heatmap(save_path='fewshot2.png')
