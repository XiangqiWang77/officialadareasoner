...
def decoder_for_gpt3(args, input, max_length, model, temperature):
    ...
    if ("few_shot" in args.method or "auto" in args.method)  and engine == "code-davinci-002":
        ...
        return get_response(model=model, prompt=input, temperature=temperature)
...
class Decoder():
    ...
    def decode(self, args, input, max_length, model, temperature):
        response = decoder_for_gpt3(args, input, max_length, model, temperature)
        return response
